...
class Cart {
    ...
    public function __construct(){
        ...
        if ($this->cart_contents === NULL){
            // set some base values //  asigna el valor 0 al carrito lo que indica que no se tiene nada en el mismo por el momento
    ...
    /**
     * Update the cart //Cambia la cantidad de el item que lleves
     * @param    array
     * @return    bool
     */
